...
const styles = StyleSheet.create({
  ...
  stretchCard: { padding: 20, gap: 10, marginVertical: 4 },
  musclePill: {
    alignSelf: 'flex-start',
    backgroundColor: 'rgba(61,255,160,0.12)',
    borderRadius: 6,
    paddingHorizontal: 10,
    paddingVertical: 4,
  },
  ...
  timerValueDone: { color: colors.neon },
  listWrap: { gap: 8, flex: 1, marginVertical: 8 },
  listItem: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  listStatus: { fontSize: 13, width: 16, fontWeight: '700' },
  listName: {
    flex: 1,
    fontSize: 13,
    fontFamily: 'SpaceGrotesk_400Regular',
